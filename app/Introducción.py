...
<div style="text-align: justify; text-justify: inter-word">Más allá de la definición del concepto, se deberán tener en cuenta los siguientes puntos:
...
+ Factores cambiantes a lo largo de la historia y entre los distintos tipos de economías: las causas o indicadores de crisis para un determinado periodo temporal o tipo de economía pueden no ser válidas para otros.</div>''', unsafe_allow_html=True)

with tab3:

    st.markdown('''## **:orange[Problemáticas]**
    
<div style="text-align: justify; text-justify: inter-word">Algunos de los problemas que han sido necesario abordar a lo largo del desarrollo del proyecto han sido:
...
+ Decisión sobre métricas válidas debido al desbalance de datos, etc.</div>''', unsafe_allow_html=True)
