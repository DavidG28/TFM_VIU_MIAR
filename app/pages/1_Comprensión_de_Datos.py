...
{'Nombre de Atributo' : ['year', 'country', 'iso', 'ifs', 'pop', 'rgdpmad', 'rgdbarro', 'rconsbarro', 'gdp', 'iy', 'cpi', 'ca', 'imports', 'exports', 'narrowm', 'money', 
 ...
 'Agregado monetario amplio (M3)', 'Tipo de interés a corto plazo', 'Tipo de interés a largo plazo', 'Precio de la vivienda', 'Tasa de desempleo', 'Nivel salarial',
 'Deuda pública ponderada por PIB', 'Ingresos públicos', 'Gastos públicos', 'Tipo de cambio vs Dólar', 'Precio/Beneficio', 'Precio/Beneficio estricto',
 'Cambios tasa base bruta', 'Créditos al sector privado', 'Créditos hipotecarios al sector privado', 'Crédito a los hogares', 'Crédito a los negocios',
 'Deuda corporativa', 'Precio/Beneficio tipo', 'Precio/Beneficio base', 'Rentabilidad total del capital', 'Rentabilidad total de la vivienda',
 'Rentabilidad del bono del estado', 'Tarifa de facturación', 'Rentabilidad de la vivienda interpolado', 'Plusvalía de vivienda interpolado',
 'Plusvalía de vivienda', 'Retorno rentabilidad alquiler de vivienda', 'Rentabilidad alquiler de vivienda', 'Ganancia por acciones', 'Ganancia por dividendo', 
 'Ganancia por acciones interpolado', 'Ganancia total por acciones interpolado', 'Ganancia por dividendo interpolado', 'Tipo bono del estado', 'Retorno por dividendo',
 'Retorno de riqueza', 'Retorno por activos de riesgo', 'Retorno por activos seguros', 'Ratio de capital bancario', 'Ratio préstamos/depósitos bancarios',
 'Ratio de financiación no básica bancaria`]})
